  ...
  return (
    <div className="game-page">
      <header className="game-nav">
        ...
        <nav className="game-nav-links" aria-label="Điều hướng DiabloSMP"><Link href="/server-game/tinh-nang">Tính năng</Link><Link href="/server-game/xep-hang">Xếp hạng</Link><Link href="/server-game/tin-tuc">Tin tức</Link><Link href="/server-game/wiki">Wiki</Link><Link href="/server-game/gia-ban">Giá bán</Link><Link href="/server-game/info">Thông tin</Link></nav>
